  ...
  ),
  {
    variants: {
      zType: {
        ...
        destructive:
          'bg-[oklch(0.53_0.222_22.5)] text-white shadow-xs hover:bg-[oklch(0.53_0.222_22.5)]/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60',
        outline:
