  ...
  ),
  {
    variants: {
      zType: {
        ...
        destructive:
          'bg-[oklch(0.365_0.148_26.751)] text-white shadow-xs hover:bg-[#5e010c] focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60',
        outline:
